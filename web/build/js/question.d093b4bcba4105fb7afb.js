...
(function ($) {
    ...
    $addReplyForm.validate({
        submitHandler: function submitHandler() {
            ...
            util.request('questionReply.add', { questionId: window.questionId }, $addReplyForm.serialize(), { success: function success(response) {
                    if (response.code == 0) {
...
(function ($) {
    ...
    $addQuestionForm.validate({
        submitHandler: function submitHandler() {
            ...
            util.request('question.add', { topicId: window.topicId }, $addQuestionForm.serialize(), { success: function success(response) {
                    if (response.code == 0) {
