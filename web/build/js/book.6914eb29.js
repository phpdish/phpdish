...
h.compoundRuleCodes={},c=0,p=h.compoundRules.length;c<p;c++){var e=h.compoundRules[c];for(f=0,d=e.length;f<d;f++)h.compoundRuleCodes[e[f]]=[]}
...
for(c=0,p=h.compoundRules.length;c<p;c++){var t=h.compoundRules[c],o="";for(f=0,d=t.length;f<d;f++){var a=t[f];a in h.compoundRuleCodes?o+="("+h.compoundRuleCodes[a].join("|")+")":o+=a}h.compoundRules[c]=new RegExp(o,"i")}h.loaded=!0,i.asyncLoad&&i.loadedCallback&&i.loadedCallback(h)}i=i||{},this.dictionary=null,this.rules={},this.dictionaryTable={},this.compoundRules=[],this.compoundRuleCodes={},this.replacementTable=[],this.flags=i.flags||{},this.memoized={},this.loaded=!1;var u,c,f,p,d,h=this;
...
e=this._removeAffixComments(e);var c=e.split("\n");for(o=0,s=c.length;o<s;o++){t=c[o];var f=t.split(/\s+/),p=f[0];if("PFX"==p||"SFX"==p){var d=f[1],h=f[2];r=parseInt(f[3],10);var g=[];for(a=o+1,l=o+1+r;a<l;a++){n=c[a],i=n.split(/\s+/);var m=i[2],v=i[3].split("/"),y=v[0];"0"===y&&(y="");var b=this.parseRuleCodes(v[1]),w=i[4],_={};_.add=y,b.length>0&&(_.continuationClasses=b),"."!==w&&(_.match="SFX"===p?new RegExp(w+"$"):new RegExp("^"+w)),"0"!=m&&(_.remove="SFX"===p?new RegExp(m+"$"):m),g.push(_)}u[d]={type:p,combineable:"Y"==h,entries:g},o+=r}else if("COMPOUNDRULE"===p){for(r=parseInt(f[1],10),a=o+1,l=o+1+r;a<l;a++)t=c[a],i=t.split(/\s+/),this.compoundRules.push(i[1]);o+=r}else"REP"===p?(i=t.split(/\s+/),3===i.length&&this.replacementTable.push([i[1],i[2]])):
// ONLYINCOMPOUND
// COMPOUNDMIN
// FLAG
// KEEPCASE
// NEEDAFFIX
this.flags[p]=f[1]}return u},/**
...
"NEEDAFFIX"in this.flags&&-1!=u.indexOf(this.flags.NEEDAFFIX)||t(l,u);for(var c=0,f=u.length;c<f;c++){var p=u[c],d=this.rules[p];if(d)for(var h=this._applyRule(l,d),g=0,m=h.length;g<m;g++){var v=h[g];if(t(v,[]),d.combineable)for(var y=c+1;y<f;y++){var b=u[y],w=this.rules[b];if(w&&w.combineable&&d.type!=w.type)for(var _=this._applyRule(v,w),k=0,x=_.length;k<x;k++){var S=_[k];t(S,[])}}}p in this.compoundRuleCodes&&this.compoundRuleCodes[p].push(l)}}else t(l.trim(),[])}return r},/**
	 * Removes comment lines and then cleans up blank lines and trailing whitespace.
	 *
...
var o,a,s=n([e]),l=n(s),c=r(s.concat(l)),f={};for(o=0,a=c.length;o<a;o++)c[o]in f?f[c[o]]+=1:f[c[o]]=1;var p=[];for(o in f)f.hasOwnProperty(o)&&p.push([o,f[o]]);p.sort(i).reverse();var d=[],h="lowercase";for(e.toUpperCase()===e?h="uppercase":e.substr(0,1).toUpperCase()+e.substr(1).toLowerCase()===e&&(h="capitalized"),o=0,a=Math.min(t,p.length);o<a;o++)"uppercase"===h?p[o][0]=p[o][0].toUpperCase():"capitalized"===h&&(p[o][0]=p[o][0].substr(0,1).toUpperCase()+p[o][0].substr(1)),u.hasFlag(p[o][0],"NOSUGGEST")||d.push(p[o][0]);return d}(e),limit:t},this.memoized[e].suggestions}}}(),e.exports=i}).call(t,"/",n("EuP9").Buffer)},/***/
"5x2J":/***/
 ...
 */
function p(e){function t(e){/* return true, if this is a ``` or ~~~ line */
...
p=l.getLineHandle(u.line),d=r(l,u.line,p,f);if("single"===d){
// similar to some SimpleMDE _toggleBlock logic
var h=p.text.slice(0,u.ch).replace("`",""),g=p.text.slice(u.ch).replace("`","");l.replaceRange(h+g,{line:u.line,ch:0},{line:u.line,ch:99999999999999}),u.ch--,u!==c&&c.ch--,l.setSelection(u,c),l.focus()}else if("fenced"===d)if(u.line!==c.line||u.ch!==c.ch){
// use selection
// find the fenced line so we know what type it is (tilde, backticks, number of them)
for(i=u.line;i>=0&&(p=l.getLineHandle(i),!t(p));i--);var m,v,y,b,w=l.getTokenAt({line:i,ch:1}),_=n(w).fencedChars;
// check for selection going up against fenced lines, in which case we don't want to add more fencing
t(l.getLineHandle(u.line))?(m="",v=u.line):t(l.getLineHandle(u.line-1))?(m="",v=u.line-1):(m=_+"\n",v=u.line),t(l.getLineHandle(c.line))?(y="",b=c.line,0===c.ch&&(b+=1)):0!==c.ch&&t(l.getLineHandle(c.line+1))?(y="",b=c.line+1):(y=_+"\n",b=c.line+1),0===c.ch&&(
...
var k=u.line;if(t(l.getLineHandle(u.line))&&(// gets a little tricky if cursor is right on a fenced line
"fenced"===r(l,u.line+1)?(i=u.line,k=u.line+1):(o=u.line,k=u.line-1)),void 0===i)for(i=k;i>=0&&(p=l.getLineHandle(i),!t(p));i--);if(void 0===o)for(a=l.lineCount(),o=k;o<a&&(p=l.getLineHandle(o),!t(p));o++);l.operation(function(){l.replaceRange("",{line:i,ch:0},{line:i+1,ch:0}),l.replaceRange("",{line:o-1,ch:0},{line:o,ch:0})}),l.focus()}else if("indented"===d){if(u.line!==c.line||u.ch!==c.ch)
// use selection
i=u.line,o=c.line,0===c.ch&&o--;else{
// no selection, search for ends of this indented block
for(i=u.line;i>=0;i--)if(p=l.getLineHandle(i),!p.text.match(/^\s*$/)&&"indented"!==r(l,i,p)){i+=1;break}for(a=l.lineCount(),o=u.line;o<a;o++)if(p=l.getLineHandle(o),!p.text.match(/^\s*$/)&&"indented"!==r(l,o,p)){o-=1;break}}
// if we are going to un-indent based on a selected set of lines, and the next line is indented too, we need to
// insert a blank line so that the next line(s) continue to be indented code
var x=l.getLineHandle(o+1),S=x&&l.getTokenAt({line:o+1,ch:x.text.length-1}),T=S&&n(S).indentedCode;T&&l.replaceRange("\n",{line:o+1,ch:0});for(var E=i;E<=o;E++)l.indentLine(E,"subtract");l.focus()}else{
// insert code formatting
var C=u.line===c.line&&u.ch===c.ch&&0===u.ch,A=u.line!==c.line;C||A?function(e,t,n,r){var i=t.line+1,o=n.line+1,a=t.line!==n.line,s=r+"\n",l="\n"+r;a&&o++,
// handle last char including \n or not
a&&0===n.ch&&(l=r+"\n",o--),P(e,!1,[s,l]),e.setSelection({line:i,ch:0},{line:o,ch:0})}(l,u,c,s):P(l,!1,["`","`"])}}/**
 * Action for toggling blockquote.
 */
function d(e){M(e.codemirror,"quote")}/**
 * Action for toggling heading size: normal -> h1 -> h2 -> h3 -> h4 -> h5 -> h6 -> normal
 */
function h(e){O(e.codemirror,"smaller")}/**
 * Action for toggling heading size: normal -> h6 -> h5 -> h4 -> h3 -> h2 -> h1 -> normal
 */
function g(e){O(e.codemirror,"bigger")}/**
 * Action for toggling heading size 1
 */
function m(e){O(e.codemirror,void 0,1)}/**
 * Action for toggling heading size 2
 */
function v(e){O(e.codemirror,void 0,2)}/**
 * Action for toggling heading size 3
 */
function y(e){O(e.codemirror,void 0,3)}/**
 ...
 */
function _(e){L(e.codemirror)}/**
 * Action for drawing a link.
 */
function k(e){var t=e.codemirror,n=s(t),r=e.options,i="http://";if(r.promptURLs&&!(i=prompt(r.promptTexts.link)))return!1;P(t,n.link,r.insertTexts.link,i)}/**
 * Action for drawing an img.
 */
function x(e){var t=e.codemirror,n=s(t),r=e.options,i="http://";if(r.promptURLs&&!(i=prompt(r.promptTexts.image)))return!1;P(t,n.image,r.insertTexts.image,i)}/**
 * Action for drawing a table.
 */
function S(e){var t=e.codemirror,n=s(t),r=e.options;P(t,n.table,r.insertTexts.table)}/**
 * Action for drawing a horizontal rule.
 */
function T(e){var t=e.codemirror,n=s(t),r=e.options;P(t,n.image,r.insertTexts.horizontalRule)}/**
 * Undo action.
 */
function E(e){var t=e.codemirror;t.undo(),t.focus()}/**
 * Redo action.
 */
function C(e){var t=e.codemirror;t.redo(),t.focus()}/**
...
for(var o in Z)Z.hasOwnProperty(o)&&(-1!=o.indexOf("separator-")&&e.toolbar.push("|"),(!0===Z[o].default||e.showIcons&&e.showIcons.constructor===Array&&-1!=e.showIcons.indexOf(o))&&e.toolbar.push(o))}
// Handle status bar
...
e.insertTexts=U({},X,e.insertTexts||{}),
// Merging the promptTexts, with the given options
e.promptTexts=J,
// Merging the blockStyles, with the given options
e.blockStyles=U({},K,e.blockStyles||{}),
// Merging the shortcuts, with the given options
e.shortcuts=U({},Y,e.shortcuts||{}),
...
function F(){if("object"!=typeof localStorage)return!1;try{localStorage.setItem("smde_localStorage",1),localStorage.removeItem("smde_localStorage")}catch(e){return!1}return!0}/*global require,module*/
var q=n("8U58");n("Ar2w"),n("9G1F"),n("zdrL"),n("f6fj"),n("jz+E"),n("afnM"),n("U80t"),n("bWRU"),n("ezqs");var z=n("h6VQ"),D=n("QdX/"),H=/Mac/.test(navigator.platform),$={toggleBold:u,toggleItalic:c,drawLink:k,toggleHeadingSmaller:h,toggleHeadingBigger:g,drawImage:x,toggleBlockquote:d,toggleOrderedList:w,toggleUnorderedList:b,toggleCodeBlock:p,togglePreview:R,toggleStrikethrough:f,toggleHeading1:m,toggleHeading2:v,toggleHeading3:y,cleanBlock:_,drawTable:S,drawHorizontalRule:T,undo:E,redo:C,toggleSideBySide:A,toggleFullScreen:l},Y={toggleBold:"Cmd-B",toggleItalic:"Cmd-I",drawLink:"Cmd-K",toggleHeadingSmaller:"Cmd-H",toggleHeadingBigger:"Shift-Cmd-H",cleanBlock:"Cmd-E",drawImage:"Cmd-Alt-I",toggleBlockquote:"Cmd-'",toggleOrderedList:"Cmd-Alt-L",toggleUnorderedList:"Cmd-L",toggleCodeBlock:"Cmd-Alt-C",togglePreview:"Cmd-P",toggleSideBySide:"F9",toggleFullScreen:"F11"},V=function(e){for(var t in $)if($[t]===e)return t;return null},W=function(){var e=!1;return function(t){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(t)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(t.substr(0,4)))&&(e=!0)}(navigator.userAgent||navigator.vendor||window.opera),e},G="",Z={bold:{name:"bold",action:u,className:"fa fa-bold",title:"Bold",default:!0},italic:{name:"italic",action:c,className:"fa fa-italic",title:"Italic",default:!0},strikethrough:{name:"strikethrough",action:f,className:"fa fa-strikethrough",title:"Strikethrough"},heading:{name:"heading",action:h,className:"fa fa-header",title:"Heading",default:!0},"heading-smaller":{name:"heading-smaller",action:h,className:"fa fa-header fa-header-x fa-header-smaller",title:"Smaller Heading"},"heading-bigger":{name:"heading-bigger",action:g,className:"fa fa-header fa-header-x fa-header-bigger",title:"Bigger Heading"},"heading-1":{name:"heading-1",action:m,className:"fa fa-header fa-header-x fa-header-1",title:"Big Heading"},"heading-2":{name:"heading-2",action:v,className:"fa fa-header fa-header-x fa-header-2",title:"Medium Heading"},"heading-3":{name:"heading-3",action:y,className:"fa fa-header fa-header-x fa-header-3",title:"Small Heading"},"separator-1":{name:"separator-1"},code:{name:"code",action:p,className:"fa fa-code",title:"Code"},quote:{name:"quote",action:d,className:"fa fa-quote-left",title:"Quote",default:!0},"unordered-list":{name:"unordered-list",action:b,className:"fa fa-list-ul",title:"Generic List",default:!0},"ordered-list":{name:"ordered-list",action:w,className:"fa fa-list-ol",title:"Numbered List",default:!0},"clean-block":{name:"clean-block",action:_,className:"fa fa-eraser fa-clean-block",title:"Clean block"},"separator-2":{name:"separator-2"},link:{name:"link",action:k,className:"fa fa-link",title:"Create Link",default:!0},image:{name:"image",action:x,className:"fa fa-picture-o",title:"Insert Image",default:!0},table:{name:"table",action:S,className:"fa fa-table",title:"Insert Table"},"horizontal-rule":{name:"horizontal-rule",action:T,className:"fa fa-minus",title:"Insert Horizontal Line"},"separator-3":{name:"separator-3"},preview:{name:"preview",action:R,className:"fa fa-eye no-disable",title:"Toggle Preview",default:!0},"side-by-side":{name:"side-by-side",action:A,className:"fa fa-columns no-disable no-mobile",title:"Toggle Side by Side",default:!0},fullscreen:{name:"fullscreen",action:l,className:"fa fa-arrows-alt no-disable no-mobile",title:"Toggle Fullscreen",default:!0},"separator-4":{name:"separator-4"},guide:{name:"guide",action:"https://simplemde.com/markdown-guide",className:"fa fa-question-circle",title:"Markdown Guide",default:!0},"separator-5":{name:"separator-5"},undo:{name:"undo",action:E,className:"fa fa-undo no-disable",title:"Undo"},redo:{name:"redo",action:C,className:"fa fa-repeat no-disable",title:"Redo"}},X={link:["[","](#url#)"],image:["![](","#url#)"],table:["","\n\n| Column 1 | Column 2 | Column 3 |\n| -------- | -------- | -------- |\n| Text     | Text     | Text     |\n\n"],horizontalRule:["","\n\n-----\n\n"]},J={link:"URL for the link:",image:"URL of the image:"},K={bold:"**",code:"```",italic:"*"};/**
 * Default markdown render.
 */
B.prototype.markdown=function(e){if(D){
// Initialize
var t={};
// Return
// Update options
// Set options
return this.options&&this.options.renderingConfig&&!1===this.options.renderingConfig.singleLineBreaks?t.breaks=!1:t.breaks=!0,this.options&&this.options.renderingConfig&&!0===this.options.renderingConfig.codeSyntaxHighlighting&&window.hljs&&(t.highlight=function(e){return window.hljs.highlightAuto(e).value}),D.setOptions(t),D(e)}},/**
...
null!==t.shortcuts[o]&&null!==$[o]&&function(e){i[r(t.shortcuts[e])]=function(){$[e](n)}}(o);i.Enter="newlineAndIndentContinueMarkdownList",i.Tab="tabAndIndentMarkdownList",i["Shift-Tab"]="shiftTabAndUnindentMarkdownList",i.Esc=function(e){e.getOption("fullScreen")&&l(n)},document.addEventListener("keydown",function(e){e=e||window.event,27==e.keyCode&&n.codemirror.getOption("fullScreen")&&l(n)},!1);var a,s;if(!1!==t.spellChecker?(a="spell-checker",s=t.parsingConfig,s.name="gfm",s.gitHubSpice=!1,z({codeMirrorInstance:q})):(a=t.parsingConfig,a.name="gfm",a.gitHubSpice=!1),this.codemirror=q.fromTextArea(e,{mode:a,backdrop:s,theme:"paper",tabSize:void 0!=t.tabSize?t.tabSize:2,indentUnit:void 0!=t.tabSize?t.tabSize:2,indentWithTabs:!1!==t.indentWithTabs,lineNumbers:!1,autofocus:!0===t.autofocus,extraKeys:i,lineWrapping:!1!==t.lineWrapping,allowDropFileTypes:["text/plain"],placeholder:t.placeholder||e.getAttribute("placeholder")||"",styleSelectedText:void 0==t.styleSelectedText||t.styleSelectedText}),!0===t.forceSync){var u=this.codemirror;u.on("change",function(){u.save()})}this.gui={},!1!==t.toolbar&&(this.gui.toolbar=this.createToolbar()),!1!==t.status&&(this.gui.statusbar=this.createStatusbar()),void 0!=t.autosave&&!0===t.autosave.enabled&&this.autosave(),this.gui.sideBySide=this.createSideBySide(),this._rendered=this.element;
...
return e.on("scroll",function(e){if(r)return void(r=!1);i=!0;var t=e.getScrollInfo().height-e.getScrollInfo().clientHeight,o=parseFloat(e.getScrollInfo().top)/t,a=(n.scrollHeight-n.clientHeight)*o;n.scrollTop=a}),n.onscroll=function(){if(i)return void(i=!1);r=!0;var t=n.scrollHeight-n.clientHeight,o=parseFloat(n.scrollTop)/t,a=(e.getScrollInfo().height-e.getScrollInfo().clientHeight)*o;e.scrollTo(0,a)},n},B.prototype.createToolbar=function(e){if((e=e||this.options.toolbar)&&0!==e.length){var t;for(t=0;t<e.length;t++)void 0!=Z[e[t]]&&(e[t]=Z[e[t]]);var n=document.createElement("div");n.className="editor-toolbar";var r=this,a={};for(r.toolbar=e,t=0;t<e.length;t++)if(("guide"!=e[t].name||!1!==r.options.toolbarGuideIcon)&&!(r.options.hideIcons&&-1!=r.options.hideIcons.indexOf(e[t].name)||("fullscreen"==e[t].name||"side-by-side"==e[t].name)&&W()))
 ...
 */
B.toggleBold=u,B.toggleItalic=c,B.toggleStrikethrough=f,B.toggleBlockquote=d,B.toggleHeadingSmaller=h,B.toggleHeadingBigger=g,B.toggleHeading1=m,B.toggleHeading2=v,B.toggleHeading3=y,B.toggleCodeBlock=p,B.toggleUnorderedList=b,B.toggleOrderedList=w,B.cleanBlock=_,B.drawLink=k,B.drawImage=x,B.drawTable=S,B.drawHorizontalRule=T,B.undo=E,B.redo=C,B.togglePreview=R,B.toggleSideBySide=A,B.toggleFullScreen=l,/**
 * Bind instance methods for exports.
 */
B.prototype.toggleBold=function(){u(this)},B.prototype.toggleItalic=function(){c(this)},B.prototype.toggleStrikethrough=function(){f(this)},B.prototype.toggleBlockquote=function(){d(this)},B.prototype.toggleHeadingSmaller=function(){h(this)},B.prototype.toggleHeadingBigger=function(){g(this)},B.prototype.toggleHeading1=function(){m(this)},B.prototype.toggleHeading2=function(){v(this)},B.prototype.toggleHeading3=function(){y(this)},B.prototype.toggleCodeBlock=function(){p(this)},B.prototype.toggleUnorderedList=function(){b(this)},B.prototype.toggleOrderedList=function(){w(this)},B.prototype.cleanBlock=function(){_(this)},B.prototype.drawLink=function(){k(this)},B.prototype.drawImage=function(){x(this)},B.prototype.drawTable=function(){S(this)},B.prototype.drawHorizontalRule=function(){T(this)},B.prototype.undo=function(){E(this)},B.prototype.redo=function(){C(this)},B.prototype.togglePreview=function(){R(this)},B.prototype.toggleSideBySide=function(){A(this)},B.prototype.toggleFullScreen=function(){l(this)},B.prototype.isPreviewActive=function(){return/editor-preview-active/.test(this.codemirror.getWrapperElement().lastChild.className)},B.prototype.isSideBySideActive=function(){return/editor-preview-active-side/.test(this.codemirror.getWrapperElement().nextSibling.className)},B.prototype.isFullscreenActive=function(){return this.codemirror.getOption("fullScreen")},B.prototype.getState=function(){return s(this.codemirror)},B.prototype.toTextArea=function(){var e=this.codemirror,t=e.getWrapperElement();t.parentNode&&(this.gui.toolbar&&t.parentNode.removeChild(this.gui.toolbar),this.gui.statusbar&&t.parentNode.removeChild(this.gui.statusbar),this.gui.sideBySide&&t.parentNode.removeChild(this.gui.sideBySide)),e.toTextArea(),this.autosaveTimeoutId&&(clearTimeout(this.autosaveTimeoutId),this.autosaveTimeoutId=void 0,this.clearAutosavedValue())},e.exports=B},/***/
"9G1F":/***/
function(e,t,n){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
var r=n("8U58");r.commands.tabAndIndentMarkdownList=function(e){var t=e.listSelections(),n=t[0].head;if(!1!==e.getStateAfter(n.line).list)return void e.execCommand("indentMore");if(e.options.indentWithTabs)e.execCommand("insertTab");else{var r=Array(e.options.tabSize+1).join(" ");e.replaceSelection(r)}},r.commands.shiftTabAndUnindentMarkdownList=function(e){var t=e.listSelections(),n=t[0].head;if(!1!==e.getStateAfter(n.line).list)return void e.execCommand("indentLess");if(e.options.indentWithTabs)e.execCommand("insertTab");else{var r=Array(e.options.tabSize+1).join(" ");e.replaceSelection(r)}}},/***/
AJcs:/***/
...
function h(e){var t,n=[];for(n[(e.length>>2)-1]=void 0,t=0;t<n.length;t+=1)n[t]=0;var r=8*e.length;for(t=0;t<r;t+=8)n[t>>5]|=(255&e.charCodeAt(t/8))<<t%32;return n}/*
  ...
  */
function g(e){return d(p(h(e),8*e.length))}/*
  * Calculate the HMAC-MD5, of a key and some data (raw strings)
  */
function m(e,t){var n,r,i=h(e),o=[],a=[];for(o[15]=a[15]=void 0,i.length>16&&(i=p(i,8*e.length)),n=0;n<16;n+=1)o[n]=909522486^i[n],a[n]=1549556828^i[n];return r=p(o.concat(h(t)),512+8*t.length),d(p(a.concat(r),640))}/*
...
function y(e){return unescape(encodeURIComponent(e))}/*
  ...
  */
function b(e){return g(y(e))}function w(e){return v(b(e))}function _(e,t){return m(y(e),y(t))}function k(e,t){return v(_(e,t))}function x(e,t,n){return t?n?_(t,e):k(t,e):n?b(e):w(e)}void 0!==(r=function(){return x}.call(t,n,t,e))&&(e.exports=r)}()},/***/
Ar2w:/***/
function(e,t,n){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
!function(e){// CommonJS
e(n("8U58"))}(function(e){"use strict";
// Auto-updating Markdown list numbers when a new item is added to the
// middle of a list
function t(e,t){var r=t.line,i=0,o=0,a=n.exec(e.getLine(r)),s=a[1];do{i+=1;var l=r+i,u=e.getLine(l),c=n.exec(u);if(c){var f=c[1],p=parseInt(a[3],10)+i-o,d=parseInt(c[3],10),h=d;if(s!==f||isNaN(d)){if(s.length>f.length)return;
// This doesn't run if the next line immediatley indents, as it is
// not clear of the users intention (new indented item or same level)
if(s.length<f.length&&1===i)return;o+=1}else p===d&&(h=d+1),p>d&&(h=p+1),e.replaceRange(u.replace(n,f+h+c[4]+c[5]),{line:l,ch:0},{line:l,ch:u.length})}}while(c)}var n=/^(\s*)(>[> ]*|[*+-] \[[x ]\]\s|[*+-]\s|(\d+)([.)]))(\s*)/,r=/^(\s*)(>[> ]*|[*+-] \[[x ]\]|[*+-]|(\d+)[.)])(\s*)$/,i=/[*+-]\s/;e.commands.newlineAndIndentContinueMarkdownList=function(o){if(o.getOption("disableInput"))return e.Pass;for(var a=o.listSelections(),s=[],l=0;l<a.length;l++){var u=a[l].head,c=o.getStateAfter(u.line),f=!1!==c.list,p=0!==c.quote,d=o.getLine(u.line),h=n.exec(d),g=/^\s*$/.test(d.slice(0,u.ch));if(!a[l].empty()||!f&&!p||!h||g)return void o.execCommand("newlineAndIndent");if(r.test(d))/>\s*$/.test(d)||o.replaceRange("",{line:u.line,ch:0},{line:u.line,ch:u.ch+1}),s[l]="\n";else{var m=h[1],v=h[5],y=!(i.test(h[2])||h[2].indexOf(">")>=0),b=y?parseInt(h[3],10)+1+h[4]:h[2].replace("x"," ");s[l]="\n"+m+b+v,y&&t(o,u)}}o.replaceSelections(s)}})},/***/
EKta:/***/
...
return a!==r&&(e=e.slice(0,a)),e}function f(e,t){var n=t.length<0?0:0|h(t.length);e=i(e,n);for(var r=0;r<n;r+=1)e[r]=255&t[r];return e}function p(e,t,n,r){// this throws if `array` is not a valid ArrayBuffer
...
var r=!1;;)switch(t){case"ascii":case"latin1":case"binary":return n;case"utf8":case"utf-8":case void 0:return $(e).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return 2*n;case"hex":return n>>>1;case"base64":return W(e).length;default:if(r)return $(e).length;// assume utf8
...
n>>>=0,t>>>=0,n<=t)return"";for(e||(e="utf8");;)switch(e){case"hex":return M(this,t,n);case"utf8":case"utf-8":return A(this,t,n);case"ascii":return P(this,t,n);case"latin1":case"binary":return O(this,t,n);case"base64":return C(this,t,n);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return N(this,t,n);default:if(r)throw new TypeError("Unknown encoding: "+e);e=(e+"").toLowerCase(),r=!0}}function y(e,t,n){var r=e[t];e[t]=e[n],e[n]=r}
...
// encode utf8
if(i=null,n<128){if((t-=1)<0)break;o.push(n)}else if(n<2048){if((t-=2)<0)break;o.push(n>>6|192,63&n|128)}else if(n<65536){if((t-=3)<0)break;o.push(n>>12|224,n>>6&63|128,63&n|128)}else{if(!(n<1114112))throw new Error("Invalid code point");if((t-=4)<0)break;o.push(n>>18|240,n>>12&63|128,n>>6&63|128,63&n|128)}}return o}function Y(e){for(var t=[],n=0;n<e.length;++n)
// Node's code seems to be doing this and not & 0x7F..
t.push(255&e.charCodeAt(n));return t}function V(e,t){for(var n,r,i,o=[],a=0;a<e.length&&!((t-=2)<0);++a)n=e.charCodeAt(a),r=n>>8,i=n%256,o.push(i),o.push(r);return o}function W(e){return X.toByteArray(z(e))}function G(e,t,n,r){for(var i=0;i<r&&!(i+n>=t.length||i>=e.length);++i)t[i+n]=e[i];return i}function Z(e){return e!==e}/*!
...
var X=n("EKta"),J=n("ujcs"),K=n("sOR5");t.Buffer=o,t.SlowBuffer=g,t.INSPECT_MAX_BYTES=50,/**
...
if(t<0||this.length<t||this.length<n)throw new RangeError("Out of range index");if(n<=t)return this;t>>>=0,n=void 0===n?this.length:n>>>0,e||(e=0);var a;if("number"==typeof e)for(a=t;a<n;++a)this[a]=e;else{var s=o.isBuffer(e)?e:$(new o(e,r).toString()),l=s.length;for(a=0;a<n-t;++a)this[a+t]=s[a%l]}return this};
// HELPER FUNCTIONS
// ================
var ee=/[^+\/0-9A-Za-z-_]/g}).call(t,n("DuR2"))},/***/
"QdX/":/***/
function(e,t,n){/* WEBPACK VAR INJECTION */
 ...
 */
function r(e,t){if(this.options=t||h.defaults,this.links=e,this.rules=m.normal,this.renderer=this.options.renderer||new i,this.renderer.options=this.options,!this.links)throw new Error("Tokens array requires a `links` property.");this.options.pedantic?this.rules=m.pedantic:this.options.gfm&&(this.options.breaks?this.rules=m.breaks:this.rules=m.gfm)}/**
 * Renderer
 */
 ...
 * Helpers
 */
function s(e,t){return e.replace(t?/&/g:/&(?!#?\w+;)/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function l(e){
 ...
 * Preprocessing
 */
n.prototype.lex=function(e){return e=e.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    ").replace(/\u00a0/g," ").replace(/\u2424/g,"\n"),this.token(e,!0)},/**
 * Lexing
 */
n.prototype.token=function(e,t){e=e.replace(/^ +$/gm,"");for(var n,r,i,o,a,s,l,u,c,f,p,h,m;e;)
// code
if(
// newline
...
if(t&&(i=this.rules.nptable.exec(e))&&(s={type:"table",header:d(i[1].replace(/^ *| *\| *$/g,"")),align:i[2].replace(/^ *|\| *$/g,"").split(/ *\| */),cells:i[3]?i[3].replace(/\n$/,"").split("\n"):[]},s.header.length===s.align.length)){for(e=e.substring(i[0].length),u=0;u<s.align.length;u++)/^ *-+: *$/.test(s.align[u])?s.align[u]="right":/^ *:-+: *$/.test(s.align[u])?s.align[u]="center":/^ *:-+ *$/.test(s.align[u])?s.align[u]="left":s.align[u]=null;for(u=0;u<s.cells.length;u++)s.cells[u]=d(s.cells[u],s.header.length);this.tokens.push(s)}else
// hr
...
this.token(i,t),this.tokens.push({type:"blockquote_end"});else
// list
if(i=this.rules.list.exec(e)){for(e=e.substring(i[0].length),o=i[2],p=o.length>1,this.tokens.push({type:"list_start",ordered:p,start:p?+o:""}),
// Get each top-level item.
i=i[0].match(this.rules.item),n=!1,f=i.length,u=0;u<f;u++)s=i[u],
...
this.options.smartLists&&u!==f-1&&(a=g.bullet.exec(i[u+1])[0],o===a||o.length>1&&a.length>1||(e=i.slice(u+1).join("\n")+e,u=f-1)),
// Determine whether item is loose or not.
// Use: /(^|\n)(?! )[^\n]+\n\n(?!\s*$)/
// for discount behavior.
r=n||/\n\n(?!\s*$)/.test(s),u!==f-1&&(n="\n"===s.charAt(s.length-1),r||(r=n)),
// Check for task list items
h=/^\[[ xX]\] /.test(s),m=void 0,h&&(m=" "!==s[1],s=s.replace(/^\[[ xX]\] +/,"")),this.tokens.push({type:r?"loose_item_start":"list_item_start",task:h,checked:m}),
// Recurse.
...
// def
if(t&&(i=this.rules.def.exec(e)))e=e.substring(i[0].length),i[3]&&(i[3]=i[3].substring(1,i[3].length-1)),c=i[1].toLowerCase().replace(/\s+/g," "),this.tokens.links[c]||(this.tokens.links[c]={href:i[2],title:i[3]});else
// table (gfm)
if(t&&(i=this.rules.table.exec(e))&&(s={type:"table",header:d(i[1].replace(/^ *| *\| *$/g,"")),align:i[2].replace(/^ *|\| *$/g,"").split(/ *\| */),cells:i[3]?i[3].replace(/(?: *\| *)?\n$/,"").split("\n"):[]},s.header.length===s.align.length)){for(e=e.substring(i[0].length),u=0;u<s.align.length;u++)/^ *-+: *$/.test(s.align[u])?s.align[u]="right":/^ *:-+: *$/.test(s.align[u])?s.align[u]="center":/^ *:-+ *$/.test(s.align[u])?s.align[u]="left":s.align[u]=null;for(u=0;u<s.cells.length;u++)s.cells[u]=d(s.cells[u].replace(/^ *\| *| *\| *$/g,""),s.header.length);this.tokens.push(s)}else
// lheading
 ...
 */
var m={escape:/^\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/,autolink:/^<(scheme:[^\s\x00-\x1f<>]*|email)>/,url:f,tag:"^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",// CDATA section
link:/^!?\[(label)\]\(href(?:\s+(title))?\s*\)/,reflink:/^!?\[(label)\]\[(?!\s*\])((?:\\[\[\]]?|[^\[\]\\])+)\]/,nolink:/^!?\[(?!\s*\])((?:\[[^\[\]]*\]|\\[\[\]]|[^\[\]])*)\](?:\[\])?/,strong:/^__([^\s][\s\S]*?[^\s])__(?!_)|^\*\*([^\s][\s\S]*?[^\s])\*\*(?!\*)|^__([^\s])__(?!_)|^\*\*([^\s])\*\*(?!\*)/,em:/^_([^\s][\s\S]*?[^\s_])_(?!_)|^_([^\s_][\s\S]*?[^\s])_(?!_)|^\*([^\s][\s\S]*?[^\s*])\*(?!\*)|^\*([^\s*][\s\S]*?[^\s])\*(?!\*)|^_([^\s_])_(?!_)|^\*([^\s*])\*(?!\*)/,code:/^(`+)\s*([\s\S]*?[^`]?)\s*\1(?!`)/,br:/^ {2,}\n(?!\s*$)/,del:f,text:/^[\s\S]+?(?=[\\<!\[`*]|\b_| {2,}\n|$)/};m._escapes=/\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g,m._scheme=/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/,m._email=/[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,m.autolink=u(m.autolink).replace("scheme",m._scheme).replace("email",m._email).getRegex(),m._attribute=/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,m.tag=u(m.tag).replace("comment",g._comment).replace("attribute",m._attribute).getRegex(),m._label=/(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/,m._href=/\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f()\\]*\)|[^\s\x00-\x1f()\\])*?)/,m._title=/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,m.link=u(m.link).replace("label",m._label).replace("href",m._href).replace("title",m._title).getRegex(),m.reflink=u(m.reflink).replace("label",m._label).getRegex(),/**
 * Normal Inline Grammar
 */
m.normal=p({},m),/**
 * Pedantic Inline Grammar
 */
m.pedantic=p({},m.normal,{strong:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,em:/^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/,link:u(/^!?\[(label)\]\((.*?)\)/).replace("label",m._label).getRegex(),reflink:u(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",m._label).getRegex()}),/**
 * GFM Inline Grammar
 */
m.gfm=p({},m.normal,{escape:u(m.escape).replace("])","~|])").getRegex(),url:u(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("email",m._email).getRegex(),_backpedal:/(?:[^?!.,:;*_~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_~)]+(?!$))+/,del:/^~~(?=\S)([\s\S]*?\S)~~/,text:u(m.text).replace("]|","~]|").replace("|","|https?://|ftp://|www\\.|[a-zA-Z0-9.!#$%&'*+/=?^_`{\\|}~-]+@|").getRegex()}),/**
 * GFM + Line Breaks Inline Grammar
 */
m.breaks=p({},m.gfm,{br:u(m.br).replace("{2,}","*").getRegex(),text:u(m.gfm.text).replace("{2,}","*").getRegex()}),/**
 * Expose Inline Rules
 */
r.rules=m,/**
 * Static Lexing/Compiling Method
 */
r.output=function(e,t,n){return new r(t,n).output(e)},/**
 * Lexing/Compiling
 */
r.prototype.output=function(e){for(var t,n,i,o,a,l="";e;)
// escape
if(a=this.rules.escape.exec(e))e=e.substring(a[0].length),l+=a[1];else
// autolink
if(a=this.rules.autolink.exec(e))e=e.substring(a[0].length),"@"===a[2]?(n=s(this.mangle(a[1])),i="mailto:"+n):(n=s(a[1]),i=n),l+=this.renderer.link(i,null,n);else
// url (gfm)
if(this.inLink||!(a=this.rules.url.exec(e))){
// tag
if(a=this.rules.tag.exec(e))!this.inLink&&/^<a /i.test(a[0])?this.inLink=!0:this.inLink&&/^<\/a>/i.test(a[0])&&(this.inLink=!1),e=e.substring(a[0].length),l+=this.options.sanitize?this.options.sanitizer?this.options.sanitizer(a[0]):s(a[0]):a[0];else
// link
if(a=this.rules.link.exec(e))e=e.substring(a[0].length),this.inLink=!0,i=a[2],this.options.pedantic?(t=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i),t?(i=t[1],o=t[3]):o=""):o=a[3]?a[3].slice(1,-1):"",i=i.trim().replace(/^<([\s\S]*)>$/,"$1"),l+=this.outputLink(a,{href:r.escapes(i),title:r.escapes(o)}),this.inLink=!1;else
// reflink, nolink
if((a=this.rules.reflink.exec(e))||(a=this.rules.nolink.exec(e))){if(e=e.substring(a[0].length),t=(a[2]||a[1]).replace(/\s+/g," "),!(t=this.links[t.toLowerCase()])||!t.href){l+=a[0].charAt(0),e=a[0].substring(1)+e;continue}this.inLink=!0,l+=this.outputLink(a,t),this.inLink=!1}else
// strong
if(a=this.rules.strong.exec(e))e=e.substring(a[0].length),l+=this.renderer.strong(this.output(a[4]||a[3]||a[2]||a[1]));else
// em
if(a=this.rules.em.exec(e))e=e.substring(a[0].length),l+=this.renderer.em(this.output(a[6]||a[5]||a[4]||a[3]||a[2]||a[1]));else
// code
if(a=this.rules.code.exec(e))e=e.substring(a[0].length),l+=this.renderer.codespan(s(a[2].trim(),!0));else
// br
if(a=this.rules.br.exec(e))e=e.substring(a[0].length),l+=this.renderer.br();else
// del (gfm)
if(a=this.rules.del.exec(e))e=e.substring(a[0].length),l+=this.renderer.del(this.output(a[1]));else
// text
if(a=this.rules.text.exec(e))e=e.substring(a[0].length),l+=this.renderer.text(s(this.smartypants(a[0])));else if(e)throw new Error("Infinite loop on byte: "+e.charCodeAt(0))}else a[0]=this.rules._backpedal.exec(a[0])[0],e=e.substring(a[0].length),"@"===a[2]?(n=s(a[0]),i="mailto:"+n):(n=s(a[0]),i="www."===a[1]?"http://"+n:n),l+=this.renderer.link(i,null,n);return l},r.escapes=function(e){return e?e.replace(r.rules._escapes,"$1"):e},/**
 * Compile Link
 */
r.prototype.outputLink=function(e,t){var n=t.href,r=t.title?s(t.title):null;return"!"!==e[0].charAt(0)?this.renderer.link(n,r,this.output(e[1])):this.renderer.image(n,r,s(e[1]))},/**
 ...
 * Mangle Links
 */
r.prototype.mangle=function(e){if(!this.options.mangle)return e;for(var t,n="",r=e.length,i=0;i<r;i++)t=e.charCodeAt(i),Math.random()>.5&&(t="x"+t.toString(16)),n+="&#"+t+";";return n},i.prototype.code=function(e,t,n){if(this.options.highlight){var r=this.options.highlight(e,t);null!=r&&r!==e&&(n=!0,e=r)}return t?'<pre><code class="'+this.options.langPrefix+s(t,!0)+'">'+(n?e:s(e,!0))+"</code></pre>\n":"<pre><code>"+(n?e:s(e,!0))+"</code></pre>"},i.prototype.blockquote=function(e){return"<blockquote>\n"+e+"</blockquote>\n"},i.prototype.html=function(e){return e},i.prototype.heading=function(e,t,n){return this.options.headerIds?"<h"+t+' id="'+this.options.headerPrefix+n.toLowerCase().replace(/[^\w]+/g,"-")+'">'+e+"</h"+t+">\n":"<h"+t+">"+e+"</h"+t+">\n"},i.prototype.hr=function(){return this.options.xhtml?"<hr/>\n":"<hr>\n"},i.prototype.list=function(e,t,n){var r=t?"ol":"ul";return"<"+r+(t&&1!==n?' start="'+n+'"':"")+">\n"+e+"</"+r+">\n"},i.prototype.listitem=function(e){return"<li>"+e+"</li>\n"},i.prototype.checkbox=function(e){return"<input "+(e?'checked="" ':"")+'disabled="" type="checkbox"'+(this.options.xhtml?" /":"")+"> "},i.prototype.paragraph=function(e){return"<p>"+e+"</p>\n"},i.prototype.table=function(e,t){return t&&(t="<tbody>"+t+"</tbody>"),"<table>\n<thead>\n"+e+"</thead>\n"+t+"</table>\n"},i.prototype.tablerow=function(e){return"<tr>\n"+e+"</tr>\n"},i.prototype.tablecell=function(e,t){var n=t.header?"th":"td";return(t.align?"<"+n+' align="'+t.align+'">':"<"+n+">")+e+"</"+n+">\n"},
// span level renderer
i.prototype.strong=function(e){return"<strong>"+e+"</strong>"},i.prototype.em=function(e){return"<em>"+e+"</em>"},i.prototype.codespan=function(e){return"<code>"+e+"</code>"},i.prototype.br=function(){return this.options.xhtml?"<br/>":"<br>"},i.prototype.del=function(e){return"<del>"+e+"</del>"},i.prototype.link=function(e,t,n){if(this.options.sanitize){try{var r=decodeURIComponent(l(e)).replace(/[^\w:]/g,"").toLowerCase()}catch(e){return n}if(0===r.indexOf("javascript:")||0===r.indexOf("vbscript:")||0===r.indexOf("data:"))return n}this.options.baseUrl&&!y.test(e)&&(e=c(this.options.baseUrl,e));try{e=encodeURI(e).replace(/%25/g,"%")}catch(e){return n}var i='<a href="'+s(e)+'"';return t&&(i+=' title="'+t+'"'),i+=">"+n+"</a>"},i.prototype.image=function(e,t,n){this.options.baseUrl&&!y.test(e)&&(e=c(this.options.baseUrl,e));var r='<img src="'+e+'" alt="'+n+'"';return t&&(r+=' title="'+t+'"'),r+=this.options.xhtml?"/>":">"},i.prototype.text=function(e){return e},
// no need for block level renderers
o.prototype.strong=o.prototype.em=o.prototype.codespan=o.prototype.del=o.prototype.text=function(e){return e},o.prototype.link=o.prototype.image=function(e,t,n){return""+n},o.prototype.br=function(){return""},/**
 * Static Parse Method
 */
a.parse=function(e,t){return new a(t).parse(e)},/**
 * Parse Loop
 */
a.prototype.parse=function(e){this.inline=new r(e.links,this.options),
// use an InlineLexer with a TextRenderer to extract pure text
this.inlineText=new r(e.links,p({},this.options,{renderer:new o})),this.tokens=e.reverse();for(var t="";this.next();)t+=this.tok();return t},/**
 * Next Token
 */
a.prototype.next=function(){return this.token=this.tokens.pop()},/**
 * Preview Next Token
 */
a.prototype.peek=function(){return this.tokens[this.tokens.length-1]||0},/**
 * Parse Text Tokens
 */
a.prototype.parseText=function(){for(var e=this.token.text;"text"===this.peek().type;)e+="\n"+this.next().text;return this.inline.output(e)},/**
 * Parse Current Token
 */
a.prototype.tok=function(){switch(this.token.type){case"space":return"";case"hr":return this.renderer.hr();case"heading":return this.renderer.heading(this.inline.output(this.token.text),this.token.depth,l(this.inlineText.output(this.token.text)));case"code":return this.renderer.code(this.token.text,this.token.lang,this.token.escaped);case"table":var e,t,n,r,i="",o="";for(
// header
n="",e=0;e<this.token.header.length;e++)n+=this.renderer.tablecell(this.inline.output(this.token.header[e]),{header:!0,align:this.token.align[e]});for(i+=this.renderer.tablerow(n),e=0;e<this.token.cells.length;e++){for(t=this.token.cells[e],n="",r=0;r<t.length;r++)n+=this.renderer.tablecell(this.inline.output(t[r]),{header:!1,align:this.token.align[r]});o+=this.renderer.tablerow(n)}return this.renderer.table(i,o);case"blockquote_start":for(o="";"blockquote_end"!==this.next().type;)o+=this.tok();return this.renderer.blockquote(o);case"list_start":o="";for(var a=this.token.ordered,s=this.token.start;"list_end"!==this.next().type;)o+=this.tok();return this.renderer.list(o,a,s);case"list_item_start":for(o="",this.token.task&&(o+=this.renderer.checkbox(this.token.checked));"list_item_end"!==this.next().type;)o+="text"===this.token.type?this.parseText():this.tok();return this.renderer.listitem(o);case"loose_item_start":for(o="";"list_item_end"!==this.next().type;)o+=this.tok();return this.renderer.listitem(o);case"html":
// TODO parse inline content if parameter markdown=1
return this.renderer.html(this.token.text);case"paragraph":return this.renderer.paragraph(this.inline.output(this.token.text));case"text":return this.renderer.paragraph(this.parseText())}};var v={},y=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;f.exec=f,/**
 * Options
 */
h.options=h.setOptions=function(e){return p(h.defaults,e),h},h.getDefaults=function(){return{baseUrl:null,breaks:!1,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:new i,sanitize:!1,sanitizer:null,silent:!1,smartLists:!1,smartypants:!1,tables:!0,xhtml:!1}},h.defaults=h.getDefaults(),/**
 * Expose
 */
h.Parser=a,h.parser=a.parse,h.Renderer=i,h.TextRenderer=o,h.Lexer=n,h.lexer=n.lex,h.InlineLexer=r,h.inlineLexer=r.output,h.parse=h,e.exports=h}(this||"undefined"!=typeof window&&window)}).call(t,n("DuR2"))},/***/
TrA0:/***/
...
!function(e){// CommonJS
e(n("8U58"))}(function(e){"use strict";function t(e){e.state.markedSelection&&e.operation(function(){a(e)})}function n(e){e.state.markedSelection&&e.state.markedSelection.length&&e.operation(function(){i(e)})}function r(e,t,n,r){if(0!=u(t,n))for(var i=e.state.markedSelection,o=e.state.markedSelectionStyle,a=t.line;;){var c=a==t.line?t:l(a,0),f=a+s,p=f>=n.line,d=p?n:l(f,0),h=e.markText(c,d,{className:o});if(null==r?i.push(h):i.splice(r++,0,h),p)break;a=f}}function i(e){for(var t=e.state.markedSelection,n=0;n<t.length;++n)t[n].clear();t.length=0}function o(e){i(e);for(var t=e.listSelections(),n=0;n<t.length;n++)r(e,t[n].from(),t[n].to())}function a(e){if(!e.somethingSelected())return i(e);if(e.listSelections().length>1)return o(e);var t=e.getCursor("start"),n=e.getCursor("end"),a=e.state.markedSelection;if(!a.length)return r(e,t,n);var l=a[0].find(),c=a[a.length-1].find();if(!l||!c||n.line-t.line<=s||u(t,c.to)>=0||u(n,l.from)<=0)return o(e);for(;u(t,l.from)>0;)a.shift().clear(),l=a[0].find();for(u(t,l.from)<0&&(l.to.line-t.line<s?(a.shift().clear(),r(e,t,l.to,0)):r(e,t,l.from,0));u(n,c.to)<0;)a.pop().clear(),c=a[a.length-1].find();u(n,c.to)>0&&(n.line-c.from.line<s?(a.pop().clear(),r(e,c.from,n)):r(e,c.to,n))}e.defineOption("styleSelectedText",!1,function(r,a,s){var l=s&&s!=e.Init;a&&!l?(r.state.markedSelection=[],r.state.markedSelectionStyle="string"==typeof a?a:"CodeMirror-selectedtext",o(r),r.on("cursorActivity",t),r.on("change",n)):!a&&l&&(r.off("cursorActivity",t),r.off("change",n),i(r),r.state.markedSelection=r.state.markedSelectionStyle=null)});var s=8,l=e.Pos,u=e.cmpPos})},/***/
VQun:/***/
function(e,t,n){"use strict";/* WEBPACK VAR INJECTION */
(function(e){function t(e){return e&&e.__esModule?e:{default:e}}n("6vhR");var r=n("V8mf"),i=t(r),o=n("reOk"),a=t(o),s=n("Y81h"),l=t(s);n("u4Nl");var u=n("wGMW"),c=t(u),f=n("Jov0"),p=t(f),d=n("b1yq"),h=n("mueN"),g=t(h),m=n("ylcc"),v=t(m),y=n("5x2J"),b=t(y),w=n("N4UN"),_=t(w),k=n("AJcs"),x=t(k),S=e("#book-details");S.length>0&&function(e){function t(){var t=S.find('[data-role="add-chapter"]'),n=(0,g.default)(t);t.on("click",function(){if(n.isDisabled())return!1;n.lock(),p.default.dialog.inputs(Translator.trans("book.chapter_name"),[{name:"title",required:!0}],{messages:{title:{required:Translator.trans("book.required_chapter_name")}}},{okValue:Translator.trans("ui.create"),cancelValue:Translator.trans("ui.cancel"),width:350}).then(function(e){console.log(e),p.default.request("book.add_summary",{slug:window.book.slug},e).done(function(){location.reload()}).fail(function(){p.default.dialog.message(Translator.trans("book.create_chapter_error")).flash()}),n.release()},function(){n.release()})}),S.find('[data-role="chapter"]').each(function(){var t=e(this),n=t.find('[data-role="edit"]'),r=(t.find('[data-role="add-sub"]'),t.find('[data-role="delete"]')),i=t.find('[data-role="move"]');n.on("click",function(){p.default.dialog.inputs(Translator.trans("book.chapter_name"),[{name:"title",default:t.data("title"),required:!0}],{messages:{title:{required:Translator.trans("book.required_chapter_name")}}},{okValue:Translator.trans("ui.create"),cancelValue:Translator.trans("ui.cancel"),width:350}).then(function(e){p.default.request("book.edit_summary",{slug:window.book.slug,id:t.data("id")},e).done(function(){location.reload()}).fail(function(){p.default.dialog.message(Translator.trans("book.edit_chapter_error")).flash()})},function(){})});var o=(0,g.default)(r);r.on("click",function(){if(o.isDisabled())return!1;o.lock(),p.default.dialog.confirm(Translator.trans("book.confirm_remove_chapter")).then(function(){var e=r.closest('[data-role="sub-chapter"]');0===e.length&&(e=r.closest('[data-role="chapter"]'));var t=e.data("id");p.default.request("post.delete",t).done(function(){p.default.dialog.message(Translator.trans("book.remove_success")).flash(function(){location.reload()})}).fail(function(){p.default.dialog.message(Translator.trans("book.remove_error")).flash()}).always(function(){o.release()})},function(){o.release()})});var a=(0,g.default)(i);i.on("click",function(){var t=e(this);if(a.isDisabled())return!1;a.lock();var n=t.closest('[data-role="sub-chapter"]');0===n.length&&(n=t.closest('[data-role="chapter"]'));var r=n.data("id");p.default.request("book.move_chapter",{slug:window.book.slug,id:r},{direction:e(this).data("direction")||"up",step:1}).done(function(){location.reload()}).fail(function(){p.default.dialog.message(Translator.trans("book.move_error")).flash()}).always(function(){a.release()})})})}new c.default(e("[data-pjax-container]"),{container:"#book-details",loader:"#loader",before:function(e){p.default.htmlPlaceholder(e)},success:function(e){new d.FollowUserIntialization(e),t()}}),t()}(e);
//添加章节
var T=document.getElementById("chapter_originalBody");e(T).length>0&&function(e){var t=e("#chapter_title"),n=e("#add-chapter-form"),r=e('[data-action="add-chapter"]'),i=new b.default({element:T,autofocus:!0,spellChecker:!1,status:!1,indentWithTabs:!1,tabSize:4,autosave:{enabled:!0,uniqueId:"chapter_"+(0,x.default)(location.pathname),delay:1e3},toolbar:["bold","italic","heading","|","quote","code","table","horizontal-rule","unordered-list","ordered-list","|","link","image","|","side-by-side","fullscreen","preview","|",{name:"guide",action:"https://github.com/riku/Markdown-Syntax-CN/blob/master/syntax.md",className:"fa fa-info-circle",title:Translator.trans("editor.markdown_synax")}]});new v.default(i.codemirror),//处理附件上传的功能
r.on("click",function(){if(0===t.val().length)return p.default.dialog.message(Translator.trans("book.validation.name")).flash(),!1;var e=(0,g.default)(r).lock();return p.default.dialog.confirm(Translator.trans("book.confirm_publish")).then(function(){return n.submit(),!0},function(){return e.release(),!1}),!1}),
//添加文章验证
...
//电子书阅读页面
var E=e('[data-role="book-view"]');E.length>0&&function(e){var t=E.find('[data-role="summary"]');E.find('[data-role="toggle-summary"]').on("click",function(){E.toggleClass("with-summary")}),
//分享
new a.default(E.find('[data-role="social-share"]'),{theme:"dark-square",facebook:!1,twitter:!1}),
//代码高亮
...
//购买
var n=e('[data-role="buy"]');n.length>0&&function(){var e=(0,g.default)(n),t=n.data("slug");n.on("click",function(){var n=p.default.dialog.wait.ballPulse();p.default.request("category.follow",{slug:t}).done(function(e){if(e.require_payment)return void new _.default(e.qrcode);location.reload()}).fail(function(e){p.default.dialog.message(e.responseJSON.error).flash()}).always(function(){n.close(),e.release()})})}()}(e)}).call(t,n("0iPh"))},/***/
Y81h:/***/
...
ylcc:/***/
function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var i=n("Zrlr"),o=r(i);n("TrA0"),n("lc86"),n("hYF2");var a=n("0iPh"),s=r(a),l=n("Jov0"),u=r(l),c=function e(t,n){(0,o.default)(this,e),n=s.default.extend({uploadUrl:u.default.route.getRoutePath("upload"),jsonFieldName:"path"},n),t instanceof s.default?t.inlineattachment(n):inlineAttachment.editors.codemirror4.attach(t,n)};t.default=c},/***/
zdrL:/***/
function(e,t,n){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: http://codemirror.net/LICENSE
!function(e){// CommonJS
e(n("8U58"))}(function(e){"use strict";function t(e){var t=e.getWrapperElement();e.state.fullScreenRestore={scrollTop:window.pageYOffset,scrollLeft:window.pageXOffset,width:t.style.width,height:t.style.height},t.style.width="",t.style.height="auto",t.className+=" CodeMirror-fullscreen",document.documentElement.style.overflow="hidden",e.refresh()}function n(e){var t=e.getWrapperElement();t.className=t.className.replace(/\s*CodeMirror-fullscreen\b/,""),document.documentElement.style.overflow="";var n=e.state.fullScreenRestore;t.style.width=n.width,t.style.height=n.height,window.scrollTo(n.scrollLeft,n.scrollTop),e.refresh()}e.defineOption("fullScreen",!1,function(r,i,o){o==e.Init&&(o=!1),!o!=!i&&(i?t(r):n(r))})})}},["VQun"]);