...
(function(e){function t(e){return e&&e.__esModule?e:{default:e}}n("6vhR");var o=n("wGMW"),a=t(o),i=n("Jov0"),c=t(i),l=n("b1yq"),s=n("CqTI"),u=t(s);
//AjaxTab
new a.default(e("[data-pjax-container]"),{container:"#list-container",loader:"#loader",before:function(e){c.default.htmlPlaceholder(e)},success:function(e){new l.FollowUserIntialization(e),u.default.parse(e[0])}})}).call(t,n("9ZC0"))},/***/
wGMW:/***/
function(e,t,n){"use strict";/* WEBPACK VAR INJECTION */
(function(e){function o(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var a=n("Zrlr"),i=o(a);n("u4Nl");var c=n("Jov0"),l=(o(c),function t(n,o){var a=this;(0,i.default)(this,t),e.pjax.defaults.timeout=5e4,this.element=n,this.container=e(o.container),this.element.pjax("li a",o.container),this.options=o,this.element.on("pjax:click",function(t){e(t.target).parent().siblings().removeClass("active").end().addClass("active")}),this.loader=e(this.options.loader),
//绑定事件
