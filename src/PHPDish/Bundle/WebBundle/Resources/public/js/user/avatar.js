...
/***/ function(module, exports, __webpack_require__) {
	...
	var Avatar = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Jcrop = __webpack_require__(31);
	__webpack_require__(32);

	var dmuploader = __webpack_require__(33);
	...
	(function (a) {
	  a.Jcrop = function (b, c) {
	    function i(a) {
	      ...
	      });var M = y().mousedown(s("move")).css({ cursor: "move", position: "absolute", zIndex: 360 });return Z.support && M.bind("touchstart.jcrop", Z.createDragger("move")), I.append(M), F(), { updateVisible: w, update: x, release: B, refresh: v, isAwake: function () {
	          return b;
	    ...
	    }();Z.support && M.bind("touchstart.jcrop", Z.newSelection), J.hide(), br(!0);var bs = { setImage: bp, animateTo: bf, setSelect: bg, setOptions: bk, tellSelect: bi, tellScaled: bj, setClass: be, disable: bl, enable: bm, cancel: bn, release: bb.release, destroy: bo, focus: bd.watchKeys, getBounds: function () {
	        return [E * T, F * U];
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	(function (t) {
	  var n = "dmUploader";var r = { url: document.URL, method: "POST", extraData: {}, maxFileSize: 0, allowedTypes: "*", extFilter: null, dataType: null, fileName: "file", onInit: function () {}, onFallbackMode: function () {
	      message;
	    }, onNewFile: function (e, t) {}, onBeforeUpload: function (e) {}, onComplete: function () {}, onUploadProgress: function (e, t) {}, onUploadSuccess: function (e, t) {}, onUploadError: function (e, t) {}, onFileTypeError: function (e) {}, onFileSizeError: function (e) {}, onFileExtError: function (e) {} };var i = function (e, n) {
	    ...
	    var n = this;n.queuePos++;if (n.queuePos >= n.queue.length) {
	      ...
	      i.append(e, t);
	    });n.queueRunning = true;t.ajax({ url: n.settings.url, type: n.settings.method, dataType: n.settings.dataType, data: i, cache: false, contentType: false, processData: false, forceSync: false, xhr: function () {
