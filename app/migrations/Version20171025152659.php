 ...
 */
class Version20171025152659 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE test_comments (id INT AUTO_INCREMENT NOT NULL, thread_id VARCHAR(255) DEFAULT NULL, author_id INT DEFAULT NULL, body LONGTEXT NOT NULL, ancestors VARCHAR(1024) NOT NULL, depth INT NOT NULL, created_at DATETIME NOT NULL, state INT NOT NULL, INDEX IDX_CAFD9D7CE2904019 (thread_id), INDEX IDX_CAFD9D7CF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test_threads (id VARCHAR(255) NOT NULL, permalink VARCHAR(255) NOT NULL, is_commentable TINYINT(1) NOT NULL, num_comments INT NOT NULL, last_comment_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE chats (id INT AUTO_INCREMENT NOT NULL, sender_id INT DEFAULT NULL, recipient_id INT DEFAULT NULL, body VARCHAR(500) NOT NULL, created_at DATETIME NOT NULL, read_at DATETIME DEFAULT NULL, `read` TINYINT(1) NOT NULL, INDEX IDX_2D68180FF624B39D (sender_id), INDEX IDX_2D68180FE92F8F78 (recipient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE test_comments ADD CONSTRAINT FK_CAFD9D7CE2904019 FOREIGN KEY (thread_id) REFERENCES test_threads (id)');
        $this->addSql('ALTER TABLE test_comments ADD CONSTRAINT FK_CAFD9D7CF675F31B FOREIGN KEY (author_id) REFERENCES users (id)');
        ...
        $this->addSql('ALTER TABLE chats ADD CONSTRAINT FK_2D68180FF624B39D FOREIGN KEY (sender_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE chats ADD CONSTRAINT FK_2D68180FE92F8F78 FOREIGN KEY (recipient_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE test_comments DROP FOREIGN KEY FK_CAFD9D7CF675F31B');
        $this->addSql('ALTER TABLE notifications DROP FOREIGN KEY FK_6000B0D3A76ED395');
        $this->addSql('ALTER TABLE notifications DROP FOREIGN KEY FK_6000B0D32130303A');
        $this->addSql('ALTER TABLE chats DROP FOREIGN KEY FK_2D68180FF624B39D');
        $this->addSql('ALTER TABLE chats DROP FOREIGN KEY FK_2D68180FE92F8F78');
        ...
        $this->addSql('ALTER TABLE test_comments DROP FOREIGN KEY FK_CAFD9D7CE2904019');
        ...
        $this->addSql('DROP TABLE test_comments');
        $this->addSql('DROP TABLE test_threads');
